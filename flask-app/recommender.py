...
MOVIES = pd.read_csv(r"C:\Users\gizem\Desktop\new\POPCORN\flask-app\ml-latest-small\movies.csv")
RATINGS = pd.read_csv(r"C:\Users\gizem\Desktop\new\POPCORN\flask-app\ml-latest-small\ratings.csv")
...
# better:
with open(r'C:\Users\gizem\Desktop\new\POPCORN\flask-app\nmf_model.pkl', "rb") as file:
    m = pickle.load(file)
P = m.components_
